...
export const SUPPORTED_MODELS: AIModelConfig[] = [
  ...
  },
  {
    ...
    domSelectors: {
      inputSelector: '.chat-input-editor, div[data-slate-editor="true"], div[contenteditable="true"].chat-input, div[contenteditable="true"], textarea',
      submitSelector: 'button[data-testid*="send"], div[class*="send-button"], button[class*="send-button"], .send-button, button[aria-label="发送"], .send-icon',
      responseSelector: '.chat-content, .segment-assistant, div[class*="segment-content"], .markdown-body, div[class*="markdown"], div[data-role="assistant"], div[class*="chat-message"], div[class*="bubble"], div[class*="segment-content-box"], div.segment-content, div[class*="m-message"], article',
      stopButtonSelector: '.stop-button, button.stop-button, button[aria-label*="Stop"], button[data-testid*="stop"], div[class*="stop"]',
      inputMethod: 'innerText',
    },
  },
  {
    ...
    domSelectors: {
      inputSelector: 'textarea[data-testid="chat_input_input"], div[data-testid="chat_input_input"], textarea.semi-input-textarea, .semi-input-textarea, textarea[placeholder*="发消息"], textarea[placeholder*="输入"], div[contenteditable="true"], textarea',
      submitSelector: 'button[data-testid="chat_input_send_button"], div[data-testid="chat_input_send_button"], button[data-testid="send_button"], button.semi-button-primary, button.send-btn, button[type="submit"]',
      responseSelector: '.flow-markdown-body, div[data-testid="message-text-content"], div[class*="flow-markdown"], [data-testid="chat-message"] .flow-markdown-body, [data-testid="chat-message"], div[class*="message-content"]',
      stopButtonSelector: 'button[aria-label*="Stop"], button[data-testid*="stop"], button.semi-button:has(svg rect)',
      inputMethod: 'value',
    },
  },
  {
